...
exports.displayHelp = () => {
    process.stdout.write(`${style.colors.blue}${style.backgroundColors.green}${schema.App_description}${style.reset}\n\n`)
...
You can try the command --help for further informations`)
        ...
        console.log('options:', option, argument);
        ...
        if (!optionPattern) throw new Error(`option does not exist, refer to --help if needed`)
